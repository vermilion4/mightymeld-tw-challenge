          ...
          <div className="lg:flex items-center gap-10">
            <div>
              <div className="text-center mb-4">
                {mode === "challenge" && (
                  <p
                    className={`text-lg md:text-xl font-semibold text-indigo-500 dark:text-white mb-4 capitalize`}
                  >
                ...
                <p
                  className={`text-lg md:text-xl font-semibold text-indigo-500 dark:text-white mt-4 capitalize`}
                >
                  {mode === "normal"
                    ? `${level} Mode`
                    : `Current Player Turn: ${
              ...
              <div className="flex gap-3 justify-between mb-12 items-center">
                <div className="flex gap-3 items-center">
                  <div className="text-indigo-400 dark:text-white text-xl md:text-2xl lg:text-3xl font-medium">
                    Tries
                  </div>
              ...
              <div
                ...
                } mx-auto place-items-center bg-indigo-50 rounded-lg dark:bg-gradient-to-b dark:from-indigo-800 dark:to-indigo-900`}
              >
            ...
            >
              ...
              <div className="flex lg:flex-col gap-5 justify-between mt-6 items-center">
                <div className="flex gap-3 items-center">
                  <div className="text-indigo-400 dark:text-white text-xl md:text-2xl lg:text-3xl font-medium capitalize">
                    {playerNames.player1 || "Player 1"}
                  </div>
